      ...
      <div className="section-grid">
        {projects.map((project, index) => (
          <motion.article
            ...
            className="card-hover flex flex-col rounded-[1.75rem] border border-slate-200/80 bg-slate-50/80 p-5 sm:p-6 dark:border-white/10 dark:bg-slate-900/60"
          >
              ...
              {activeProject ? (
                <>
                  <motion.button
                    ...
                    className="tech-doc-backdrop fixed inset-0 z-50 bg-slate-950/60"
