  ...
  return (
    <section className="hero-section relative overflow-hidden rounded-[2rem] border border-slate-200/70 bg-white/70 px-4 pb-8 pt-24 text-center shadow-soft backdrop-blur sm:px-6 sm:pb-10 sm:pt-28 xl:px-10 dark:border-white/10 dark:bg-white/5">
      ...
      <div className="hero-content relative grid justify-items-center gap-8 lg:grid-cols-[1.3fr_0.7fr] lg:items-center">
        <div className="hero-copy mx-auto flex w-full max-w-3xl min-w-0 flex-col items-center">
          ...
          <motion.h1
            ...
            className="mx-auto max-w-full font-display text-[clamp(2.5rem,12vw,4.75rem)] font-semibold leading-[1.05] text-slate-900 dark:text-white"
          >
            {profile.name}
          </motion.h1>
          <motion.p
            ...
            className="mx-auto mt-5 max-w-full text-base leading-7 text-slate-600 dark:text-slate-300 sm:max-w-2xl sm:text-lg sm:leading-8"
          >
            {profile.headline}
          </motion.p>
          <motion.p
            ...
            className="mx-auto mt-4 max-w-full text-base leading-7 text-slate-500 dark:text-slate-400 sm:max-w-2xl"
          >
            {profile.summary}
          </motion.p>
          ...
          <motion.div
            ...
            className="hero-actions mt-8 flex w-full flex-col items-stretch justify-center gap-3 sm:flex-row sm:items-center"
          >
            <a
        ...
        <motion.div
          ...
          className="hero-quick glass-panel mx-auto w-full max-w-full rounded-[2rem] p-4 sm:max-w-xl sm:p-6"
        >
          <div className="rounded-[1.5rem] bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 p-5 text-center text-white sm:p-6">
            <p className="text-xs uppercase tracking-[0.3em] text-slate-400 sm:text-sm sm:tracking-[0.35em]">Quick Connect</p>
            <div className="mt-6 space-y-4">
              <a
                href={`mailto:${profile.email}`}
                className="flex min-h-11 items-center justify-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-center transition hover:bg-white/10"
              >
                <FiMail />
              ...
              <a
                ...
                className="flex min-h-11 items-center justify-center gap-3 rounded-2xl border border-coral/30 bg-coral/10 px-4 py-3 text-center font-semibold text-coral transition hover:bg-coral/20"
              >
