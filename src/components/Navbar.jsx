...
function Navbar({ onMenuClick, isDarkMode, onToggleTheme }) {
  return (
    <header className="fixed inset-x-0 top-0 z-40 px-4 pt-4 sm:px-6">
      <div className="glass-panel mx-auto flex max-w-7xl items-center justify-between rounded-full px-4 py-3 shadow-soft">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-display text-xl font-semibold leading-none text-slate-900 dark:text-white sm:text-2xl">
              Portfolio
            </p>
