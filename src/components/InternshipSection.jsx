  ...
  return (
    <section id="internship" className="section-shell">
      ...
      <motion.article
        ...
        className="card-hover rounded-[2rem] border border-slate-200/80 bg-slate-50/80 p-5 dark:border-white/10 dark:bg-slate-900/60 sm:p-6 md:p-8"
      >
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          ...
          <span className="badge shrink-0">{internship.duration}</span>
        </div>
