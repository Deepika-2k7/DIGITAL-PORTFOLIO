  ...
  return (
    <section id="linkedin" className="section-shell">
      ...
      <motion.div
        ...
        className="rounded-[2rem] bg-gradient-to-r from-slate-950 via-slate-900 to-slate-800 p-6 text-white md:p-8"
      >
        <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-2xl font-semibold">Let&apos;s connect on LinkedIn</h3>
